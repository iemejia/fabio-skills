...
gh skill install iemejia/fabio-skills fabio@v0.23.0

# Install pinned to a version (skipped during updates)
gh skill install iemejia/fabio-skills fabio --pin v0.23.0
...
└── references/
    ├── COMMANDS.md             # Full command reference (73 groups, 790+ subcommands)
